...
<form id="App-form" action="Decision.php" method="POST">
    <div id="home-page" class="home">
        <br><h5 class="text1">&nbsp;&nbsp;&nbsp;&nbsp;กรุณากรอกข้อมูลของท่านเพื่อให้ระบบทำการช่วยตัดสินใจเลือกกิจกรรมที่เหมาะสม</h5>
            ...
            <h5 class="text4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;เช่น ความบกพร่องทางการมองเห็น,ทางการได้ยินและทางการเคลื่อนไหว เป็นต้น</h5>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="dis" value="1A" onclick="toggleCheckboxes()" id="Chronic-Disease-8">&nbsp;&nbsp;ไม่มีโรคประจำตัว<br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="dis" value="2A" id="Chronic-Disease-7">&nbsp;&nbsp;ความดันโลหิตสูง<br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="dis" value="3A" id="Chronic-Disease-6">&nbsp;&nbsp;เบาหวาน<br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="dis" value="4A" id="Chronic-Disease-5">&nbsp;&nbsp;ไขมันในเลือดสูง<br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="dis" value="5A" id="Chronic-Disease-4">&nbsp;&nbsp;ข้อเข่าเสื่อม<br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="dis" value="6A" id="Chronic-Disease-3">&nbsp;&nbsp;โรคอ้วน<br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="dis" value="7A" id="Chronic-Disease-2">&nbsp;&nbsp;ซึมเศร้า<br>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="status" value="widowed"> สามีหรือภรรยาเสียชีวิต<br>
            ...
            <br><h5 class="text5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ปัจจุบันกำลังประกอบอาชีพ</h5>
            ...
            <br><h5 class="text5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;รายได้ในปัจจุบันต่อเดือน</h5>
...
var checkbox8 = document.getElementById("Chronic-Disease-8");
var otherCheckboxes = document.querySelectorAll('[name="dis"]:not(#Chronic-Disease-8)');
...
// Clear the values of other checkboxes if any of them is checked
...
// Enable or disable other checkboxes based on the "ไม่มีโรค" checkbox
for (var i = 0; i < otherCheckboxes.length; i++) {
otherCheckboxes[i].disabled = checkbox8.checked;
}
}
</script>